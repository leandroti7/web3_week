...
import { addLink } from "./services/Web3Services";
    ...
    <>
      <div className="container px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-6">
            <h1 className="dosplay-5 fw-bold text-body-emphasis lh-1 mb-3">LinkShield</h1>
            <p className="lead">Proteja seus links. Lucre com eles.</p>
            <hr/>
            <p>Cole a sua URL abaixo, defina a taxa por clique e conecte sua carteira para proteger seu link com a tecnoiologia blockchain.</p>
            ...
            <div className="row mb-3">
              <div className="col-6">
                <div className="form-floating">
                  <input type="text" id="fee" className="form-control" value={fee || "0"} onChange={onFeeChange}/> 
